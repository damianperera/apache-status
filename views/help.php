    ...
    foreach ($oDatarenderer->getCssClasses() as $sGroup=>$aData){
        ...
        foreach($aData as $key=>$aProperties){
            ...
            if ($key=="warning" || $key=="critical")
                $s.=" (&gt;".$aUserCfg["execTimeRequest"][$key]."s)";
            $s.='</div>';
        }
        $s.='</div><br>';
    }
...
echo '
        <h3>'.$aUserCfg['icons']['help-doc'] .' '. $aLangTxt['lblHelpDoc'].'</h3>
        <div class="subh3">
            <div class="hintbox">'. 
        ...
        <h3>'.$aUserCfg['icons']['help-color'] .' '. $aLangTxt['lblHelpColors'].'</h3>
        <div class="subh3">
            <div class="hintbox">'. 
        ...
        <h3>'.$aUserCfg['icons']['help-thanks'] .' '. $aLangTxt['lblHelpThanks'].'</h3>
        <div class="subh3">
            <div class="hintbox">'. 
